package com.example.truyen.SharedPreferences_Utils;
...
public class SharedPreferences_Utils {
    ...
    public void setTheme(int nID){
        SharedPreferences sharedPreferences = PreferenceManager
                .getDefaultSharedPreferences(mcontext);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt("THEME", nID);
        editor.apply();
        Log.d("kokoko", sharedPreferences.getInt("THEME", 0) + "");
    }

    public int getTheme(){
        int nID = 0;
        if (sharedPreferences.contains("THEME"))
            nID = sharedPreferences.getInt("THEME", 0);
    ...
    public void setDataSharePreferences_From_Chapter(Chapter chapter) {
        ...
        Log.d("21321321", chapter.getTitle() + "");
